...
fn local_tsaiten_preserves_document_text_control_table_candidates_when_reference_pdf_is_available()
{
    ...
    // Scoring table: the absolute-y-slot field repeats one 256-quantized value across
    // every matched row, so it cannot be direct page-space px for four distinct rows.
    assert!(layer_tree.contains(
        "\"sourceOnlyPageMarkFieldQuantizationGate\":{\"source\":\"/PageMark raw u16 subrecord field scan\",\"diagnosticOnly\":true,\"sourceBacked\":true,\"referenceBacked\":false,\"decoded\":false,\"geometryDecoded\":false,\"placementDerived\":false,\"referenceBBoxUsed\":false,\"selectionReady\":false,\"fieldIndex\":2"
    ));
    assert!(layer_tree.contains(
    ...
    assert!(layer_tree.contains(
        "\"pageMarkFieldUnitDomainGate\":{\"source\":\"/PageMark u16 geometry profile+crate mm100 field-role decode\",\"diagnosticOnly\":true,\"sourceBacked\":true,\"referenceBacked\":false,\"decoded\":false,\"geometryDecoded\":false,\"placementDerived\":false,\"referenceBBoxUsedForSelection\":false,\"selectionReady\":false,\"pageMarkU16GeometryClass\":\"mixed-payload\",\"nonZeroAdditiveUnitCandidate\":false,\"word20Is00ff\":true,\"word13\":564,\"word14\":194,\"word21\":564,\"word13PlusWord14\":758,\"word13PlusWord14EqualsWord21\":false,\"mm100ToCssPxScale\":0.037795,\"mm100DomainDecodedForThisEntry\":false,\"mm100UnknownReason\":\"page-mark-entry-field-layout-not-decoded\",\"pageMarkXWord14Mm100PxCandidate\":7.332,\"selectedWidthWordIndex\":15,\"selectedWidthWord\":423,\"selectedWidthWordMm100PxCandidate\":15.987,\"selectedWidthWordRawAsPxMinusMm100PxCandidate\":407.013,\"widthWordValueDuplicateWordIndexes\":[15],\"selectedWidthWordValueUnique\":true,\"pageMarkXWord14DecodedElsewhereAsMm100\":true,\"selectedWidthWordDecodedElsewhereAsMm100\":false,\"crateDecodedFieldRoleBasis\":\"shanaiLanSparseBorders.rowPitchAddendMm100+pageMarkW21Mm100\",\"crateDecodedFieldRoleConflict\":true,\"unitDomainConflicts\":[\"page-mark-u16-geometry-class-not-additive-unit-candidate\",\"selected-horizontal-words-decoded-as-mm100-row-pitch-elsewhere-in-crate\"],\"selectorFieldRoleAuthoritative\":false,\"renderPromotionContribution\":\"page-mark-horizontal-unit-domain-gate\",\"renderPromotionBlockedReason\":\"page-mark-horizontal-fields-read-as-raw-css-px-contradict-mm100-row-pitch-decode\"},\"renderPromotionContribution\":\"source-horizontal-width-field-role-gate\",\"renderPromotionBlockedReason\":\"page-mark-horizontal-fields-read-as-raw-css-px-contradict-mm100-row-pitch-decode\""
    ));
    assert!(layer_tree.contains(
        "\"frameBasis\":\"page-mark-word14-first-slot-word15-half-gap\",\"sourceBacked\":true,\"referenceBacked\":false,\"decoded\":false,\"geometryDecoded\":false,\"placementDerived\":false,\"coordinateBasis\":\"page-mark-u16-fields+cross-table-line-header-slots\",\"pageMarkXWord14\":194,\"pageMarkWidthWord\":423,\"firstColumnSlotUnits\":20,\"xAdjustmentUnits\":20.000,\"widthAdjustmentUnits\":2.000,\"xAdjustmentBasis\":\"cross-table-first-column-slot\",\"widthAdjustmentBasis\":\"cross-table-half-first-intercell-gap\",\"selectedX\":174.000,\"selectedWidth\":421.000"
    ));
    ...
    assert!(layer_tree.contains(
        "\"selectedWidthAdjustmentBasis\":\"cross-table-half-first-column-slot\",\"selectedFrameBasis\":\"page-mark-word14-first-slot-word21-half-slot\",\"selectionBasis\":\"compact-two-column-page-mark-word21-half-slot\",\"twoColumnWidthCandidatePresent\":true,\"threeColumnWidthCandidatePresent\":false,\"selectorMatchesCompactColumnCount\":true"
    ));
    assert!(layer_tree.contains(
        "\"pageMarkFieldUnitDomainGate\":{\"source\":\"/PageMark u16 geometry profile+crate mm100 field-role decode\",\"diagnosticOnly\":true,\"sourceBacked\":true,\"referenceBacked\":false,\"decoded\":false,\"geometryDecoded\":false,\"placementDerived\":false,\"referenceBBoxUsedForSelection\":false,\"selectionReady\":false,\"pageMarkU16GeometryClass\":\"mixed-payload\",\"nonZeroAdditiveUnitCandidate\":false,\"word20Is00ff\":true,\"word13\":564,\"word14\":194,\"word21\":564,\"word13PlusWord14\":758,\"word13PlusWord14EqualsWord21\":false,\"mm100ToCssPxScale\":0.037795,\"mm100DomainDecodedForThisEntry\":false,\"mm100UnknownReason\":\"page-mark-entry-field-layout-not-decoded\",\"pageMarkXWord14Mm100PxCandidate\":7.332,\"selectedWidthWordIndex\":21,\"selectedWidthWord\":564,\"selectedWidthWordMm100PxCandidate\":21.317,\"selectedWidthWordRawAsPxMinusMm100PxCandidate\":542.683,\"widthWordValueDuplicateWordIndexes\":[10,13,17,18,21],\"selectedWidthWordValueUnique\":false,\"pageMarkXWord14DecodedElsewhereAsMm100\":true,\"selectedWidthWordDecodedElsewhereAsMm100\":true,\"crateDecodedFieldRoleBasis\":\"shanaiLanSparseBorders.rowPitchAddendMm100+pageMarkW21Mm100\",\"crateDecodedFieldRoleConflict\":true,\"unitDomainConflicts\":[\"page-mark-u16-geometry-class-not-additive-unit-candidate\",\"selected-horizontal-words-decoded-as-mm100-row-pitch-elsewhere-in-crate\",\"selected-width-word-value-duplicated-across-page-mark-horizontal-words\"],\"selectorFieldRoleAuthoritative\":false,\"renderPromotionContribution\":\"page-mark-horizontal-unit-domain-gate\",\"renderPromotionBlockedReason\":\"page-mark-horizontal-fields-read-as-raw-css-px-contradict-mm100-row-pitch-decode\"},\"renderPromotionContribution\":\"source-horizontal-width-field-role-gate\",\"renderPromotionBlockedReason\":\"page-mark-horizontal-fields-read-as-raw-css-px-contradict-mm100-row-pitch-decode\""
    ));
    assert!(layer_tree.contains(
    ...
    assert!(layer_tree.contains(
        "\"absoluteYSlotY\":768.000,\"lineDomainProjectionVsAbsoluteYSlotResidualPx\":107.539,\"lineDomainProjectionAgreesWithAbsoluteYSlot\":false,\"sourceOnlyPageMarkFieldQuantizationGate\":{\"source\":\"/PageMark raw u16 subrecord field scan\""
    ));
    // Lower table: the 768 slot that happens to sit 0.014px from the reference top is
    // the same 256-quantized field, repeated per raw record (2,6,2) instead of per row.
    assert!(layer_tree.contains(
